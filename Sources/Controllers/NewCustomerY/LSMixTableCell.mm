...
-(void)setSection:(int)section setWithRonriTag:(int)ronriRow{
        ...
        switch (ronriRow) {
                ...
                previewLabel=[[UILabel alloc]initWithFrame:CGRectMake(150, 5, 380, 30)];
            {
                ...
                [previewLabel setText:[NSString stringWithFormat:@"%@ %@",p,c]];
                    ...
                    [previewLabel setText:[NSString stringWithFormat:@"%@",NSLocalizedString(@"None", @"未选择")]];
                }
                _LogLine();
            }
        ...
        switch (ronriRow) {
            ...
            case 1:
                ...
                _Log(@"set Preview = %@ for baby_id=%d",[previewLabel text],baby_id);
                    ...
                    [previewLabel setText:NSLocalizedString(@"None", @"未选择")];
                }
                [self addSubview:previewLabel];
                break;
            case 0:
    ...
    if(textFieldMore){
        ...
        [textFieldMore setReturnKeyType:(UIReturnKeyDone)];
    }
}
...
-(void)setBabySexCell:(int)v{
    ...
    if(v==-1){
        ...
        [baby setThe_sex:[@[NSLocalizedString(@"Boy", @"男"),NSLocalizedString(@"Girl", @"女")] objectAtIndex:v]];
         */
